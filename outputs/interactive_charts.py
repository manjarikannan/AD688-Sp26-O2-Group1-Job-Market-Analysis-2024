...
from pyspark.sql.functions import col, when, lower, round as spark_round, desc
...
fig1.write_html("outputs/salary_distribution.html", include_plotlyjs="cdn", full_html=False)
print("Chart 1 saved.")

# Chart 2: Salary by industry
...
fig2.write_html("outputs/salary_by_industry.html", include_plotlyjs="cdn", full_html=False)
print("Chart 2 saved.")
...
fig3.write_html("outputs/top_industries.html", include_plotlyjs="cdn", full_html=False)
print("Chart 3 saved.")
